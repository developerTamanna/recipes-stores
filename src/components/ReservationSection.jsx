    ...
    <section className="bg-gradient-to-br from-[#0d0d0d] via-[#1a1a1a] to-[#000000] text-white py-16 px-4 md:px-20 grid grid-cols-1 lg:grid-cols-2 gap-12 relative">
      ...
      <div className="w-full">
        ...
        <p className="text-gray-400 mb-6 text-sm md:text-base">
          Booking request <span className="text-[#c59d5f] font-medium">+88–123–123456</span> or fill out the order form
        </p>
        ...
        <form className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <select className="bg-[#111] border border-[#c59d5f] px-4 py-3 w-full text-white rounded-md focus:outline-none">
            ...
            <input
              type="date"
              className="bg-[#111] border border-[#c59d5f] px-4 py-3 w-full text-white rounded-md focus:outline-none"
            />
            <select className="bg-[#111] border border-[#c59d5f] px-4 py-3 w-full text-white rounded-md focus:outline-none">
      ...
      <div className="w-full md:pl-6">
        <h2 className="text-3xl md:text-4xl font-serif mb-6 text-[#c59d5f]">Contact Us</h2>

        <div className="space-y-6 text-sm md:text-base">
          <div>
            <p className="font-semibold">Booking Request</p>
            <p className="text-[#c59d5f] text-xl font-semibold">+88–123–123456</p>
          </div>

          <div>
            <p className="font-semibold">Location</p>
            <p className="text-gray-400">
              Restaurant St, Delicious City,<br />Sylhet 9578, BD
            </p>
          </div>

          <div>
            <p className="font-semibold">Lunch Time</p>
            <p className="text-gray-400">Monday to Sunday<br />11.00 am – 2.30pm</p>
          </div>

          <div>
            <p className="font-semibold">Dinner Time</p>
            <p className="text-gray-400">Monday to Sunday<br />05.00 pm – 10.00pm</p>
          </div>
        </div>
      </div>
