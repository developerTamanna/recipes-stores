      ...
      >
        <div className="grid grid-cols-3 text-sm gap-8 text-gray-300">
          ...
          <ul className="flex flex-col items-start space-y-4 tracking-wider uppercase text-xs">
            <li><Link  className="hover:text-[#c59d5f]">Home</Link></li>
            <li><Link  className="hover:text-[#c59d5f]">Menus</Link></li>
            <li><Link  className="hover:text-[#c59d5f]">About Us</Link></li>
            <li><Link  className="hover:text-[#c59d5f]">Our Chefs</Link></li>
            <li><Link  className="hover:text-[#c59d5f]">Contact</Link></li>
          </ul>

          {/* Center content */}
          <div className="flex flex-col items-center text-center">
            <img src="https://i.postimg.cc/sXGpgkCw/badge-1.png" alt="Grilli Logo" className="h-12 mb-6" />
            <p>Restaurant St, Delicious City, London 9578, UK</p>
            <a href="mailto:booking@grilli.com" className="text-[#c59d5f] hover:underline">
              booking@grilli.com
            </a>
            <a href="tel:+88123123456" className="text-[#c59d5f] hover:underline">
            ...
            <h2 className="text-white text-3xl font-light mb-1">Get News & Offers</h2>
            <p className="text-xs">
              Subscribe us & Get <span className="text-[#c59d5f] font-bold">25% Off.</span>
            </p>
          ...
          <ul className="flex flex-col items-end space-y-4 tracking-wider uppercase text-xs">
            <li><Link  className="hover:text-[#c59d5f]">Facebook</Link></li>
            <li><Link  className="hover:text-[#c59d5f]">Instagram</Link></li>
            <li><Link  className="hover:text-[#c59d5f]">Twitter</Link></li>
            <li><Link  className="hover:text-[#c59d5f]">YouTube</Link></li>
            <li><Link  className="hover:text-[#c59d5f]">Google Map</Link></li>
          </ul>
        </div>
      </div>
