  ...
  return (
    <section className="flex flex-col lg:flex-row  text-white relative">
      ...
      <div className="lg:w-1/2 w-full flex flex-col justify-center px-10 py-12 relative">
        <div className="text-sm tracking-widest text-yellow-600 mb-2">SPECIAL DISH</div>
        <h2 className="text-5xl font-serif font-semibold mb-6 text-yellow-500 dark:text-white">Lobster<br />Tortellini</h2>
       <p className="text-yellow-500 dark:text-white mb-6">
  Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum
  has been the industry's standard dummy text ever since the when an unknown printer took a galley of type.
  </p>
